"""
Django settings for fretexh_42619 project.
...
ROOT_URLCONF = 'fretexh_42619.urls'
...
WSGI_APPLICATION = 'fretexh_42619.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fretexh_42619 API",
    "DESCRIPTION": "API documentation for fretexh_42619 App",
    "VERSION": "v1",
}
